...
#read in data
violin_data<- read.csv("~/Downloads/Copy2 of Phase 2 Filtering - Phase 2 Filtering corrected No GN 7.22.24.csv", head = TRUE, sep = ",")

#610 wild studies
violin_data<-violin_data[violin_data$Wild.or.Captive=="Wild",]
#609 wild studies with sampling locality info
violin_data<-violin_data[is.na(violin_data$Species.Global.North.or.South)==FALSE,]
...
#555 studies, 54 taken out bc sampling in both GN & GS
...
#556 studies, 53 taken out bc sampling in multiple continents
...
#not all the same studies got removed, 17 unique studies in GN/GS dataset vs continent dataset
...
ggsave("violin_plot.svg", plot=violin_plot, width=9.5, height=4,dpi=300)
