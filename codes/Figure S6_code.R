...
#read in data
data_hist <- read.csv("~/Downloads/Copy2 of Phase 2 Filtering - Phase 2 Filtering corrected No GN 7.22.24.csv", header=TRUE)
...
delta_temp_studies
ggsave("delta_temp_studies_2.svg", plot=delta_temp_studies, width=9, height=7,dpi=300)
